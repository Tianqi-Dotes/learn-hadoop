...
@Setter
@ToString
public class ProductReduceWritable implements Writable {

    private Integer upTotal;
    private Integer downTotal;
    private Integer total;

    public ProductReduceWritable(){}
    public ProductReduceWritable(Integer upTotal, Integer downTotal, Integer total){
