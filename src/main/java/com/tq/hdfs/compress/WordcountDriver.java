...
public class WordcountDriver {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        FileInputFormat.setInputPaths(job,new Path("D:\\learnbigdata\\src\\main\\resources\\htest\\compress\\bailuyuan.txt"));
        FileOutputFormat.setOutputPath(job,new Path("D:\\learnbigdata\\src\\main\\resources\\htest\\compress\\outcompress"));
